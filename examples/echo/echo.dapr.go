...
func NewEchoClient(appID string) (*EchoClient, error) {
	cc, err := client.NewClient()
	if err != nil {
		return nil, err
	}
	return &EchoClient{cc, appID}, nil
}

func (c *EchoClient) Echo(ctx context.Context, in *EchoInput) (*EchoOutput, error) {
...
func (c *EchoClient) Text(ctx context.Context) (*string, error) {
